...
<?php include 'nav.php'; ?>
  ...
  $insert = "UPDATE users SET name='$navn', stilling='$stilling', protek='$protek', program='$prog', email='$epost', tlf='$tlf' WHERE id=$id";
