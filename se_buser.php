...
$query="SELECT * FROM us_users WHERE id = '".$id."'";
...
<?php include 'nav.php'; ?>
    ...
    <div class="main-content">
      <!--breadcrumb-->
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Bingo salgs app</div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">

								<li class="breadcrumb-item" aria-current="page"><a href="bapp_users.php"> Bruker Bingo app</a></li>
          ...
          <div class="card-body p-4">
             <div class="position-relative mb-5">
              ...
              <div class="profile-info pt-5 d-flex align-items-center justify-content-between">
                ...
                <div class="">
                  <a href="bapp_users.php" class="btn btn-grd-primary rounded-5 px-4"><i class="bi bi-back me-2"></i>Tilbake til oversikt</a>
                </div>
                <div class="">
              ...
              <div class="card-body p-4">
                <div class="d-flex align-items-start justify-content-between mb-3">
                  ...
                  <div class="col-md-5">
                    ...
                    <input type="text" class="form-control" id="username" name="username" placeholder="Brukernavn" value="<?=$username?>">
                  </div>
									<div class="col-md-3">
									...
									<div class="col-md-3">
										<label for="stilling" class="form-label">Rolle</label>

                    <select class="form-control" id="rolle" name="rolle">
                      <option value="<?=$rolle?>">Nåværende rolle: <?=$rolle?></option>
           ...
           <div class="col-12 col-xl-4" id="updatekundeinfo">
            <div class="card rounded-4">
              <div class="card-body">
                <div class="d-flex align-items-start justify-content-between mb-3">
                  <div class="">
                    <h5 class="mb-0 fw-bold">Om Bingop app bruker</h5>
                  </div>
                 ...
                 <div class="full-info">
                  <div class="info-list d-flex flex-column gap-3">
                    ...
                    <div class="info-list-item d-flex align-items-center gap-3"><span class="material-icons-outlined">code</span><p class="mb-0">Roller: <?=$rolle?></p></div>
                    <div class="info-list-item d-flex align-items-center gap-3"><span class="material-icons-outlined">flag</span><p class="mb-0">brukernavn: <?=$username?></p></div>
                    ...
                    <div class="info-list-item d-flex align-items-center gap-3"><span class="material-icons-outlined">flag</span><p class="mb-0">Sist innlogget: <?=$last_login?></p></div>
                  </div>
                </div>
              </div>
            </div>
  ...
  $insert = "UPDATE us_users SET name='$navn', role='$rolle', username='$username', email='$epost', phone='$tlf' WHERE id=$id";
  ...
  Swal.fire({
    position: "top-end",
  icon: "success",
  title: "Brukeren er oppdatert ...",
  text: "Info om Bruker er oppdatert!",
