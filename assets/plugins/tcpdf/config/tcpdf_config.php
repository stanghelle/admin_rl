 ...
 * Page format.
 */
define ('PDF_PAGE_FORMAT', 'COMMENV_N10');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Radio Lyngdal');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Radio Lyngdal');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Programoversikt Radio Lyngdal');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Stanghelle Media");
